                                    ...
                                    <div class="container">
                                        <div class="row">
											...
											if(check_module_action_access($a['actionLists'], 'Master/add_'.$moduleName)){
												$this->load->view('common/listing_links',array('arrAllLinks'=>array(0=>array('link'=>SITE_ROOT_URL.'/Master/add_'.$moduleName,'class'=>'addIcon','label'=>'Add District'))));
											} 
											?>
										</div>
									
                                <div class="row">
								<form name="submit" method="post" data-parsley-validate="" id="view_district_frm" action="<?php echo SITE_ROOT_URL.$module_action; ?>">
                                    <table class="table table-striped table-bordered" id = "example1">
                                        <tr>
											<td align="right" class="col-sm-4"><b>State Name</b></td>
											<td align="left"><?php echo $data['state_name']; ?></td>
										</tr>
										<tr>
											<td align="right" class="col-sm-4"><b>District Name</b></td>
