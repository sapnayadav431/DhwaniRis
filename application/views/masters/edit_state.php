                        ...
                        <!-- Page-Title -->
                         <div class="box box-primary">
                            <div class="panel">
                                ...
                                <div class="row">
								<form name="submit" method="post" data-parsley-validate="" id="edit_state_frm" action="<?php echo SITE_ROOT_URL.$module_action; ?>">
                                    <table class="table table-striped table-bordered" id = "example1">
                                        <tr>
									   <td align="right" class="col-sm-4"><label><b>State Name</b><sup><i class="fa fa-asterisk text-danger"></i></sup></label></td>
										<td align="left"><input type="text" class="form-control"  value="<?php echo $data['name']; ?>" name="state" required autocomplete = "off"></td>
