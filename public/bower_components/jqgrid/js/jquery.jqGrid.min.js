...
in
k)k.hasOwnProperty(g)&&(i+=" "+g+"="+k[g])}return'<tr role="row" id="'+a+'" tabindex="'+h+'" class="'+c+'"'+(""===j?"":' style="'+j+'"')+i+">"},N=function(){e.p.treeGrid&&e.p.treeGrid_bigData&&void
0!==e.p.postData.nodeid&&"string"==typeof
e.p.postData.nodeid&&(""!==e.p.postData.nodeid||parseInt(e.p.postData.nodeid,10)>0)&&(e.p.postData.rows=1e4,e.p.postData.page=1,e.p.treeGrid_rootParams.otherData.nodeid=e.p.postData.nodeid)},O=function(){e.p.treeGrid&&e.p.treeGrid_bigData&&(void
...
g,h,i,j,k,n,p,q,r,s,t,u,v,w,x,y="_id_",z="local"!==e.p.datatype&&e.p.loadonce||"jsonstring"===e.p.datatype,B=$(e),C=0,D=[],K=e.p.multiselect?1:0,L=!0===e.p.subGrid?1:0,N=!0===e.p.rownumbers?1:0,O=e.p.scroll&&"local"!==e.p.datatype?$.jgrid.randId():1,P=parseInt(e.p.rowNum,10),Q=!1,R=I(K+L+N),S=H(h),T={},U=[],V=l(m,"rowBox",!0,"jqgrow ui-row-"+e.p.direction),W=$.isFunction(e.p.afterInsertRow),X=[],Y=!1,Z=$(e).find("tbody:first"),_=N?l(m,"rownumBox",!1,"jqgrid-rownum"):"",aa=K?l(m,"multiBox",!1,"cbox"):"";for(z&&(e.p.data=[],e.p._index={},e.p.localReader.id=y),e.p.reccount=0,"local"===e.p.datatype?(g=e.p.localReader,h="local"):(g=e.p.jsonReader,h="json"),e.p.page=A($.jgrid.getAccessor(a,g.page),e.p.page),e.p.lastpage=A($.jgrid.getAccessor(a,g.total),1),e.p.records=A($.jgrid.getAccessor(a,g.records)),e.p.userData=$.jgrid.getAccessor(a,g.userdata)||{},L&&(p=$.jgrid.getMethod("addSubGridCell")),u=!1===e.p.keyName?$.isFunction(g.id)?g.id.call(e,a):g.id:e.p.keyName,g.repeatitems&&e.p.keyName&&isNaN(u)&&(u=e.p.keyIndex),t=$.jgrid.getAccessor(a,g.root),null==t&&$.isArray(a)&&(t=a),t||(t=[]),s=t.length,j=0,s>0&&e.p.page<=0&&(e.p.page=1),d&&(P*=d+1),"local"!==e.p.datatype||e.p.deselectAfterSort||(Q=!0),e.p.grouping&&(Y=!0===e.p.groupingView.groupCollapse,x=$.jgrid.getMethod("groupingPrepare"));j<s;){if(n=t[j],void
0===(w=$.jgrid.getAccessor(n,u))&&("number"==typeof
u&&null!=e.p.colModel[u+K+L+N]&&(w=$.jgrid.getAccessor(n,e.p.colModel[u+K+L+N].name)),void
0===w&&(w=O+j,0===D.length&&g.cell))){var
ba=$.jgrid.getAccessor(n,g.cell)||n;w=null!=ba&&void
0!==ba[u]?ba[u]:w,ba=null}w=e.p.idPrefix+w,Q&&(q=e.p.multiselect?-1!==$.inArray(w,e.p.selarrrow):w===e.p.selrow);var
ca=U.length;for(U.push(""),N&&U.push(G(0,j,e.p.page,e.p.rowNum,_)),K&&U.push(F(w,N,j,q,aa)),L&&U.push(p.call(B,K+N,j+b)),r=S,g.repeatitems&&(g.cell&&(n=$.jgrid.getAccessor(n,g.cell)||n),$.isArray(n)&&(r=R)),k=0;k<r.length;k++)i=$.jgrid.getAccessor(n,r[k]),T[e.p.colModel[k+K+L+N].name]=i,U.push(E(w,i,k+K+L+N,j+b,n,T));if(U[ca]=M(w,Y,q?V+" "+o:V,T,n),U.push("</tr>"),e.p.grouping&&(X.push(U),e.p.groupingView._locgr||x.call(B,T,j),U=[]),(z||!0===e.p.treeGrid&&!e.p._ald)&&(T[y]=$.jgrid.stripPref(e.p.idPrefix,w),e.p.data.push(T),e.p._index[T[y]]=e.p.data.length-1),!1===e.p.gridview&&(Z.append(U.join("")),B.triggerHandler("jqGridAfterInsertRow",[w,T,n]),W&&e.p.afterInsertRow.call(e,w,T,n),U=[]),T={},C++,j++,C===P)break}if(!0===e.p.gridview&&(v=e.p.treeANode>-1?e.p.treeANode:0,e.p.grouping?z||(B.jqGrid("groupingRender",X,e.p.colModel.length,e.p.page,P),X=null):!0===e.p.treeGrid&&v>0?$(e.rows[v]).after(U.join("")):(Z.append(U.join("")),e.grid.cols=e.rows[0].cells)),e.p.totaltime=new
Date-f,U=null,C>0&&0===e.p.records&&(e.p.records=s),!0===e.p.treeGrid)try{B.jqGrid("setTreeNode",v+1,C+v+1)}catch(a){}if(e.p.reccount=C,e.p.treeANode=-1,e.p.userDataOnFooter&&B.jqGrid("footerData","set",e.p.userData,!0),z&&(e.p.records=s,e.p.lastpage=Math.ceil(s/P)),c||e.updatepager(!1,!0),z){for(;C<s&&t[C];){if(n=t[C],void
0===(w=$.jgrid.getAccessor(n,u))&&("number"==typeof
u&&null!=e.p.colModel[u+K+L+N]&&(w=$.jgrid.getAccessor(n,e.p.colModel[u+K+L+N].name)),void
0===w&&(w=O+C,0===D.length&&g.cell))){var
da=$.jgrid.getAccessor(n,g.cell)||n;w=null!=da&&void
0!==da[u]?da[u]:w,da=null}if(n){for(w=e.p.idPrefix+w,r=S,g.repeatitems&&(g.cell&&(n=$.jgrid.getAccessor(n,g.cell)||n),$.isArray(n)&&(r=R)),k=0;k<r.length;k++)T[e.p.colModel[k+K+L+N].name]=$.jgrid.getAccessor(n,r[k]);T[y]=$.jgrid.stripPref(e.p.idPrefix,w),e.p.grouping&&x.call(B,T,C),e.p.data.push(T),e.p._index[T[y]]=e.p.data.length-1,T={}}C++}e.p.grouping&&(e.p.groupingView._locgr=!0,B.jqGrid("groupingRender",X,e.p.colModel.length,e.p.page,P),X=null)}if(!0===e.p.subGrid)try{B.jqGrid("addSubGrid",K+N)}catch(a){}}},R=function(a){function
b(a){var
...
h=$.isFunction(e.p.loadComplete),i=h?e.p.loadComplete:null,j=0;if(a=a||1,a>1?null!==g.npage?(f[g.npage]=a,j=a-1,a=1):i=function(b){e.p.page++,e.grid.hDiv.loading=!1,h&&e.p.loadComplete.call(e,b),X(a-1)}:null!==g.npage&&delete
...
p=$(e).triggerHandler("jqGridBeforeRequest");if(!1===p||"stop"===p)return;if($.isFunction(e.p.beforeRequest)&&(!1===(p=e.p.beforeRequest.call(e))||"stop"===p))return;switch($.isFunction(e.treeGrid_beforeRequest)&&e.treeGrid_beforeRequest.call(e),b=e.p.datatype.toLowerCase()){case"json":case"jsonp":case"xml":case"script":$.ajax($.extend({url:e.p.url,type:e.p.mtype,dataType:b,data:$.isFunction(e.p.serializeGridData)?e.p.serializeGridData.call(e,e.p.postData):e.p.postData,success:function(c,f,g){if(!V(c,f,g))return void
U();"xml"===b?P(c,o,a>1,j):Q(c,o,a>1,j),$(e).triggerHandler("jqGridLoadComplete",[c]),i&&i.call(e,c),$(e).triggerHandler("jqGridAfterLoadComplete",[c]),d&&e.grid.populateVisible(),e.p.treeGrid_bigData?e.p.loadonce&&(e.p.datatype="local"):(e.p.loadonce||e.p.treeGrid)&&(e.p.datatype="local"),c=null,1===a&&U(),$.isFunction(e.treeGrid_afterLoadComplete)&&e.treeGrid_afterLoadComplete.call(e)},error:function(b,c,d){$(e).triggerHandler("jqGridLoadError",[b,c,d]),$.isFunction(e.p.loadError)&&e.p.loadError.call(e,b,c,d),1===a&&U(),b=null},beforeSend:function(a,b){var
c=!0;if(c=$(e).triggerHandler("jqGridLoadBeforeSend",[a,b]),$.isFunction(e.p.loadBeforeSend)&&(c=e.p.loadBeforeSend.call(e,a,b)),void
0===c&&(c=!0),!1===c)return!1;T()}},$.jgrid.ajaxOptions,e.p.ajaxGridOptions));break;case"xmlstring":if(T(),c="string"!=typeof
e.p.datastr?e.p.datastr:$.parseXML(e.p.datastr),!V(c,200,null))return void
U();P(c),W(c,h);break;case"jsonstring":if(T(),c="string"==typeof
e.p.datastr?$.jgrid.parse(e.p.datastr):e.p.datastr,!V(c,200,null))return void
U();Q(c),W(c,h);break;case"local":case"clientside":T(),e.p.datatype="local",e.p._ald=!0;var
q=R(!1);if(!V(q,200,null))return void
U();Q(q,o,a>1,j),$(e).triggerHandler("jqGridLoadComplete",[q]),i&&i.call(e,q),$(e).triggerHandler("jqGridAfterLoadComplete",[q]),d&&e.grid.populateVisible(),U(),e.p._ald=!1}e.p._sort=!1}},Y=function(a){$("#cb_"+$.jgrid.jqID(e.p.id),e.grid.hDiv)[e.p.useProp?"prop":"attr"]("checked",a),(e.p.frozenColumns?e.p.id+"_frozen":"")&&$("#cb_"+$.jgrid.jqID(e.p.id),e.grid.fhDiv)[e.p.useProp?"prop":"attr"]("checked",a)},Z=function(a,b){var
...
c;return"stop"!==(c=$(e).triggerHandler("jqGridPaging",[a,b]))&&($.isFunction(e.p.onPaging)&&(c=e.p.onPaging.call(e,a,b)),"stop"!==c&&(e.p.selrow=null,e.p.multiselect&&(e.p.selarrrow=[],Y(!1)),e.p.savedRow=[],!0))};if(a=a.substr(1),b+="_"+a,c="pg_"+a,d=a+"_left",f=a+"_center",g=a+"_right",$("#"+$.jgrid.jqID(a)).append("<div id='"+c+"' class='ui-pager-control' role='group'><table "+l(m,"pagerTable",!1,"ui-pg-table ui-common-table ui-pager-table")+"><tbody><tr><td id='"+d+"' align='left'></td><td id='"+f+"' align='center' style='white-space:pre;'></td><td id='"+g+"' align='right'></td></tr></tbody></table></div>").attr("dir","ltr"),e.p.rowList.length>0){t='<td dir="'+i+'">',t+="<select "+l(m,"pgSelectBox",!1,"ui-pg-selbox")+' size="1" role="listbox" title="'+($.jgrid.getRegional(e,"defaults.pgrecs",e.p.pgrecs)||"")+'">';var
...
j=0,k=u.length;j<k;j++)j>0&&(e.p.sortname+=", "),e.p.sortname+=u[j],j!==k-1&&(e.p.sortname+=" "+v[j]);e.p.sortorder=v[k-1]},aa=function(a,b,c,d,f){if(e.p.colModel[b].sortable&&!(e.p.savedRow.length>0)){if(c||(e.p.lastsort===b&&""!==e.p.sortname?"asc"===e.p.sortorder?e.p.sortorder="desc":"desc"===e.p.sortorder&&(e.p.sortorder="asc"):e.p.sortorder=e.p.colModel[b].firstsortorder||"asc",e.p.page=1),e.p.multiSort)_(b,f,d);else{if(d){if(e.p.lastsort===b&&e.p.sortorder===d&&!c)return;e.p.sortorder=d}var
g,h=e.grid.headers[e.p.lastsort]?e.grid.headers[e.p.lastsort].el:null,i=e.p.frozenColumns?f:e.grid.headers[b].el,j="single"===e.p.viewsortcols[1];g=$(h).find("span.ui-grid-ico-sort"),g.addClass(n),j&&$(g).css("display","none"),$(h).attr("aria-selected","false"),e.p.frozenColumns&&(g=e.grid.fhDiv.find("span.ui-grid-ico-sort"),g.addClass(n),j&&g.css("display","none"),e.grid.fhDiv.find("th").attr("aria-selected","false")),g=$(i).find("span.ui-icon-"+e.p.sortorder),g.removeClass(n),j&&g.css("display",""),$(i).attr("aria-selected","true"),e.p.viewsortcols[0]||(e.p.lastsort!==b?(e.p.frozenColumns&&e.grid.fhDiv.find("span.s-ico").hide(),$("span.s-ico",h).hide(),$("span.s-ico",i).show()):""===e.p.sortname&&$("span.s-ico",i).show()),a=a.substring(5+e.p.id.length+1),e.p.sortname=e.p.colModel[b].index||a}if("stop"===$(e).triggerHandler("jqGridSortCol",[e.p.sortname,b,e.p.sortorder]))return void(e.p.lastsort=b);if($.isFunction(e.p.onSortCol)&&"stop"===e.p.onSortCol.call(e,e.p.sortname,b,e.p.sortorder))return void(e.p.lastsort=b);if("local"===e.p.datatype?e.p.deselectAfterSort&&$(e).jqGrid("resetSelection"):(e.p.selrow=null,e.p.multiselect&&Y(!1),e.p.selarrrow=[],e.p.savedRow=[]),e.p.scroll){var
k=e.grid.bDiv.scrollLeft;J.call(e,!0,!1),e.grid.hDiv.scrollLeft=k}e.p.subGrid&&"local"===e.p.datatype&&$("td.sgexpanded","#"+$.jgrid.jqID(e.p.id)).each(function(){$(this).trigger("click")}),e.p._sort=!0,X(),e.p.lastsort=b,e.p.sortname!==a&&b&&(e.p.lastsort=b)}},ba=function(){var
...
a=$.inArray(this.name,e.p.groupingView.groupField);a>=0&&e.p.groupingView.groupColumnShow.length>a&&(this.hidden=!e.p.groupingView.groupColumnShow[a])}this.widthOrg=b=A(this.width,0),!1===this.hidden&&(g+=b+h,this.fixed?l+=b+h:i++)}),isNaN(e.p.width)&&(e.p.width=g+(!1!==e.p.shrinkToFit||isNaN(e.p.height)?0:j)),f.width=parseInt(e.p.width,10),e.p.tblwidth=g,!1===e.p.shrinkToFit&&!0===e.p.forceFit&&(e.p.forceFit=!1),!0===e.p.shrinkToFit&&i>0&&(c=f.width-h*i-l,isNaN(e.p.height)||(c-=j,k=!0),g=0,$.each(e.p.colModel,function(d){!1!==this.hidden||this.fixed||(b=Math.round(c*this.width/(e.p.tblwidth-h*i-l)),this.width=b,g+=b,a=d)}),d=0,k?f.width-l-(g+h*i)!==j&&(d=f.width-l-(g+h*i)-j):k||0===Math.abs(f.width-l-(g+h*i))||(d=f.width-l-(g+h*i)-Da),e.p.colModel[a].width+=d,e.p.tblwidth=g+d+h*i+l,e.p.tblwidth>e.p.width&&(e.p.colModel[a].width-=e.p.tblwidth-parseInt(e.p.width,10),e.p.tblwidth=e.p.width))},ca=function(a){var
b,c=a,d=a;for(b=a+1;b<e.p.colModel.length;b++)if(!0!==e.p.colModel[b].hidden){d=b;break}return d-c},da=function(a){var
b=$(e.grid.headers[a].el),c=[b.position().left+b.outerWidth()];return"rtl"===e.p.direction&&(c[0]=e.p.width-c[0]),c[0]-=e.grid.bDiv.scrollLeft,c.push($(e.grid.hDiv).position().top),c.push($(e.grid.bDiv).offset().top-$(e.grid.hDiv).offset().top+$(e.grid.bDiv).height()),c},ea=function(a){var
b,c=e.grid.headers,d=$.jgrid.getCellIndex(a);for(b=0;b<c.length;b++)if(a===c[b].el){d=b;break}return d},fa=function(a,b,c){var
...
x="<div>"+$.jgrid.getRegional(e,"colmenu.searchTitle")+"</div>";x+='<div><select size="1" id="oper1" class="'+s.filter_select+'">',$.each(v.odata,function(a,b){i=b.oper===l?'selected="selected"':"",-1!==$.inArray(b.oper,g)&&(r+='<option value="'+b.oper+'" '+i+">"+b.text+"</option>")}),x+=r,x+="</select></div>",j.append(x);var
...
z=$.extend(k.searchoptions,{name:k.index||k.name,id:"sval1_"+e.p.idPrefix+k.name,oper:"search"}),A=$.jgrid.createEl.call(e,k.stype,z,y,!1,$.extend({},$.jgrid.ajaxOptions,e.p.ajaxSelectOptions||{}));$(A).addClass(s.filter_input),x=$("<div></div>").append(A),j.append(x),x='<div><select size="1" id="operand" class="'+s.filter_select+'">',$.each(h,function(a,b){i=b.op===n?'selected="selected"':"",x+="<option value='"+b.op+"' "+i+">"+b.text+"</option>"}),x+="</select></div>",j.append(x),r="",$.each(v.odata,function(a,b){i=b.oper===o?'selected="selected"':"",-1!==$.inArray(b.oper,g)&&(r+='<option value="'+b.oper+'" '+i+">"+b.text+"</option>")}),x='<div><select size="1" id="oper2" class="'+s.filter_select+'">'+r+"</select></div>",j.append(x),y=q||"",z=$.extend(k.searchoptions,{name:k.index||k.name,id:"sval2_"+e.p.idPrefix+k.name,oper:"search"}),A=$.jgrid.createEl.call(e,k.stype,z,y,!1,$.extend({},$.jgrid.ajaxOptions,e.p.ajaxSelectOptions||{})),$(A).addClass(s.filter_input),x=$("<div></div>").append(A),j.append(x),x="<div>",x+="<div class='search_buttons'><a tabindex='0' id='bs_reset' class='fm-button "+w.button+" ui-reset'>"+v.Reset+"</a></div>",x+="<div class='search_buttons'><a tabindex='0' id='bs_search' class='fm-button "+w.button+" ui-search'>"+v.Find+"</a></div>",x+="</div>",j.append(x),j=$('<li class="ui-menu-item" role="presentation"></li>').append(j),j=$('<ul id="search_menu" class="ui-search-menu modal-content" role="menu" tabindex="0" style="left:'+c+'px;"></ul>').append(j),$(d).append(j),$("#search_menu").addClass("ui-menu "+s.menu_widget),$.jgrid.isElementInViewport($("#search_menu")[0])||$("#search_menu").css("left",-parseInt($("#column_menu").innerWidth(),10)+"px"),$("#bs_reset, #bs_search","#search_menu").hover(function(){$(this).addClass(p)},function(){$(this).removeClass(p)}),$("#bs_reset",j).on("click",function(a){e.p.colFilters[k.name]={},e.p.postData.filters=ha(),e.p.search=!1,$(e).trigger("reloadGrid"),$("#column_menu").remove()}),$("#bs_search",j).on("click",function(a){e.p.colFilters[k.name]={oper1:$("#oper1","#search_menu").val(),value1:$("#sval1_"+e.p.idPrefix+k.name,"#search_menu").val(),rule:$("#operand","#search_menu").val(),oper2:$("#oper2","#search_menu").val(),value2:$("#sval2_"+e.p.idPrefix+k.name,"#search_menu").val()},e.p.postData.filters=ha(),e.p.search=!0,$(e).trigger("reloadGrid"),$("#column_menu").remove()})}},ha=function(){var
a="AND",b='{"groupOp":"'+a+'","rules":[], "groups" : [',c=0;for(var
d
in
e.p.colFilters)if(e.p.colFilters.hasOwnProperty(d)){var
f=e.p.colFilters[d];$.isEmptyObject(f)||(c>0&&(b+=","),b+='{"groupOp": "'+f.rule+'", "rules" : [',b+='{"field":"'+d+'",',b+='"op":"'+f.oper1+'",',f.value1+="",b+='"data":"'+f.value1.replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}',f.value2&&(b+=',{"field":"'+d+'",',b+='"op":"'+f.oper2+'",',f.value2+="",b+='"data":"'+f.value2.replace(/\\/g,"\\\\").replace(/\"/g,'\\"')+'"}'),b+="]}",c++)}return b+="]}"},ia=function(a,b){var
c=e.p.colModel[a],d=e.p.groupingView;-1!==b?d.groupField.splice(b,1):d.groupField.push(c.name),$(e).jqGrid("groupingGroupBy",d.groupField),e.p.frozenColumns&&($(e).jqGrid("destroyFrozenColumns"),$(e).jqGrid("setFrozenColumns"))},ja=function(a,b){var
c,d=[],f=e.p.colModel.length,g=-1,h=e.p.colModel;for(c=0;c<f;c++)h[c].frozen&&(g=c),d.push(c);d.splice(a,1),d.splice(g+(b?1:0),0,a),h[a].frozen=b,$(e).jqGrid("destroyFrozenColumns"),$(e).jqGrid("remapColumns",d,!0),$(e).jqGrid("setFrozenColumns")},ka=function(a,b,c){b=parseInt(b,10),c=parseInt(c,10)+10;var
d,f,g='<ul id="column_menu" role="menu" tabindex="0">',h="",i="</ul>",j="",k=e.p.colModel[a],l=$.extend({sorting:!0,columns:!0,filtering:!0,seraching:!0,grouping:!0,freeze:!0},k.coloptions),m=$.jgrid.getRegional(e,"colmenu"),n=e.p.colNames[a],o=[],q=$.trim(k.name);o.push(h),l.sorting&&(h='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="sortasc"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+r+" "+s.icon_sort_asc+'"></span></td><td class="menu_text">'+m.sortasc+"</td></tr></table></a></li>",h+='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="sortdesc"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+r+" "+s.icon_sort_desc+'"></span></td><td class="menu_text">'+m.sortdesc+"</td></tr></table></a></li>",o.push(h)),l.columns&&(h='<li class="ui-menu-item divider" role="separator"></li>',h+='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="columns"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+r+" "+s.icon_columns+'"></span></td><td class="menu_text">'+m.columns+"</td></tr></table></a></li>",o.push(h)),l.filtering&&(h='<li class="ui-menu-item divider" role="separator"></li>',h+='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="filtering"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+r+" "+s.icon_filter+'"></span></td><td class="menu_text">'+m.filter+" "+n+"</td></tr></table></a></li>",o.push(h)),l.grouping&&(d=$.inArray(k.name,e.p.groupingView.groupField),h='<li class="ui-menu-item divider" role="separator"></li>',h+='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="grouping"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+r+" "+s.icon_group+'"></span></td><td class="menu_text">'+(-1!==d?m.ungrouping:m.grouping+" "+n)+"</td></tr></table></a></li>",o.push(h)),l.freeze&&(f=!k.frozen||!e.p.frozenColumns,h='<li class="ui-menu-item divider" role="separator"></li>',h+='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="freeze"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+r+" "+s.icon_freeze+'"></span></td><td class="menu_text">'+(f?m.freeze+" "+n:m.unfreeze)+"</td></tr></table></a></li>",o.push(h));for(var
t
in
e.p.colMenuCustom)if(e.p.colMenuCustom.hasOwnProperty(t)){var
u=e.p.colMenuCustom[t],v=u.exclude.split(",");v=$.map(v,function(a){return $.trim(a)}),(u.colname===q||"_all_"===u.colname&&-1===$.inArray(q,v))&&(j='<li class="ui-menu-item divider" role="separator"></li>',h='<li class="ui-menu-item" role="presentation"><a class="g-menu-item" tabindex="0" role="menuitem" data-value="'+u.id+'"><table class="ui-common-table"><tr><td class="menu_icon"><span class="'+r+" "+u.icon+'"></span></td><td class="menu_text">'+u.title+"</td></tr></table></a></li>","last"===u.position?(o.push(j),o.push(h)):"first"===u.position&&(o.unshift(j),o.unshift(h)))}if(o.unshift(g),o.push(i),$("#gbox_"+e.p.id).append(o.join("")),$("#column_menu").addClass("ui-search-menu modal-content column-menu jqgrid-column-menu ui-menu "+s.menu_widget).css({left:b,top:c}),"ltr"===e.p.direction){var
w=$("#column_menu").width()+26;$("#column_menu").css("left",b-w+"px")}$("#column_menu > li > a").hover(function(){$("#col_menu").remove(),$("#search_menu").remove();var
b,c;"columns"===$(this).attr("data-value")&&(b=$(this).parent().width()+8,c=$(this).parent().position().top-5,fa(c,b,$(this).parent())),"filtering"===$(this).attr("data-value")&&(b=$(this).parent().width()+8,c=$(this).parent().position().top-5,ga(a,c,b,$(this).parent())),$(this).addClass(p)},function(){$(this).removeClass(p)}).click(function(){var
b=$(this).attr("data-value"),c=e.grid.headers[a].el;if("sortasc"===b?aa("jqgh_"+e.p.id+"_"+k.name,a,!0,"asc",c):"sortdesc"===b?aa("jqgh_"+e.p.id+"_"+k.name,a,!0,"desc",c):"grouping"===b?ia(a,d):"freeze"===b&&ja(a,f),-1===b.indexOf("sort")&&"grouping"!==b&&"freeze"!==b||$(this).remove(),e.p.colMenuCustom.hasOwnProperty(b)){var
g=e.p.colMenuCustom[b];$.isFunction(g.funcname)&&(g.funcname.call(e,q),g.closeOnRun&&$(this).remove())}}),parseFloat($("#column_menu").css("left"))<0&&$("#column_menu").css("left",$(e).css("left"))};for((e.p.colMenu||e.p.menubar)&&$("body").on("click",function(a){if(!$(a.target).closest("#column_menu").length)try{$("#column_menu").remove()}catch(a){}if(!$(a.target).closest(".ui-jqgrid-menubar").length)try{$("#"+e.p.id+"_menubar").hide()}catch(a){}}),this.p.id=this.id,-1===$.inArray(e.p.multikey,z)&&(e.p.multikey=!1),e.p.keyName=!1,j=0;j<e.p.colModel.length;j++)y="string"==typeof
...
la,ma,na,oa,pa,qa,ra,sa,ta,ua="<thead><tr class='ui-jqgrid-labels' role='row'>",va="",wa="",xa="";if(!0===e.p.shrinkToFit&&!0===e.p.forceFit)for(j=e.p.colModel.length-1;j>=0;j--)if(!e.p.colModel[j].hidden){e.p.colModel[j].resizable=!1;break}if("horizontal"===e.p.viewsortcols[1]?(wa=" ui-i-asc",xa=" ui-i-desc"):"single"===e.p.viewsortcols[1]&&(wa=" ui-single-sort-asc",xa=" ui-single-sort-desc",va=" style='display:none'",e.p.viewsortcols[0]=!1),la=t?"class='ui-th-div-ie'":"",sa="<span class='s-ico' style='display:none'>",sa+="<span sort='asc'  class='ui-grid-ico-sort ui-icon-asc"+wa+" ui-sort-"+i+" "+n+" "+r+" "+l(m,"icon_asc",!0)+"'"+va+"></span>",sa+="<span sort='desc' class='ui-grid-ico-sort ui-icon-desc"+xa+" ui-sort-"+i+" "+n+" "+r+" "+l(m,"icon_desc",!0)+"'"+va+"></span></span>",e.p.multiSort&&e.p.sortname)for(u=e.p.sortname.split(","),j=0;j<u.length;j++)w=$.trim(u[j]).split(" "),u[j]=$.trim(w[0]),v[j]=w[1]?$.trim(w[1]):e.p.sortorder||"asc";for(j=0;j<this.p.colNames.length;j++){var
ya=e.p.headertitles?' title="'+$.jgrid.stripHtml(e.p.colNames[j])+'"':"";ta=e.p.colModel[j],ta.hasOwnProperty("colmenu")||(ta.colmenu="rn"!==ta.name&&"cb"!==ta.name&&"subgrid"!==ta.name),ua+="<th id='"+e.p.id+"_"+ta.name+"' role='columnheader' "+l(m,"headerBox",!1,"ui-th-column ui-th-"+i)+" "+ya+">",ma=ta.index||ta.name,ua+="<div class='ui-th-div' id='jqgh_"+e.p.id+"_"+ta.name+"' "+la+">"+e.p.colNames[j],ta.width?ta.width=parseInt(ta.width,10):ta.width=150,"boolean"!=typeof
ta.title&&(ta.title=!0),ta.lso="",ma===e.p.sortname&&(e.p.lastsort=j),e.p.multiSort&&-1!==(w=$.inArray(ma,u))&&(ta.lso=v[w]),ua+=sa,e.p.colMenu&&ta.colmenu&&(ua+="<a class='"+("ltr"===e.p.direction?"colmenu":"colmenu-rtl")+"'><span class='colmenuspan "+r+" "+s.icon_menu+"'></span></a>"),ua+="</div></th>"}if(ua+="</tr></thead>",sa=null,ta=null,$(this).append(ua),$("thead tr:first th",this).hover(function(){$(this).addClass(p)},function(){$(this).removeClass(p)}),this.p.multiselect){var
za,Aa=[];$("#cb_"+$.jgrid.jqID(e.p.id),this).on("click",function(){e.p.selarrrow=[];var
a=!0===e.p.frozenColumns?e.p.id+"_frozen":"";this.checked?($(e.rows).each(function(b){b>0&&($(this).hasClass("ui-subgrid")||$(this).hasClass("jqgroup")||$(this).hasClass(n)||$(this).hasClass("jqfoot")||($("#jqg_"+$.jgrid.jqID(e.p.id)+"_"+$.jgrid.jqID(this.id))[e.p.useProp?"prop":"attr"]("checked",!0),$(this).addClass(o).attr("aria-selected","true"),e.p.selarrrow.push(this.id),e.p.selrow=this.id,a&&($("#jqg_"+$.jgrid.jqID(e.p.id)+"_"+$.jgrid.jqID(this.id),e.grid.fbDiv)[e.p.useProp?"prop":"attr"]("checked",!0),$("#"+$.jgrid.jqID(this.id),e.grid.fbDiv).addClass(o))))}),za=!0,Aa=[]):($(e.rows).each(function(b){b>0&&($(this).hasClass("ui-subgrid")||$(this).hasClass("jqgroup")||$(this).hasClass(n)||$(this).hasClass("jqfoot")||($("#jqg_"+$.jgrid.jqID(e.p.id)+"_"+$.jgrid.jqID(this.id))[e.p.useProp?"prop":"attr"]("checked",!1),$(this).removeClass(o).attr("aria-selected","false"),Aa.push(this.id),a&&($("#jqg_"+$.jgrid.jqID(e.p.id)+"_"+$.jgrid.jqID(this.id),e.grid.fbDiv)[e.p.useProp?"prop":"attr"]("checked",!1),$("#"+$.jgrid.jqID(this.id),e.grid.fbDiv).removeClass(o))))}),e.p.selrow=null,za=!1),$(e).triggerHandler("jqGridSelectAll",[za?e.p.selarrrow:Aa,za]),$.isFunction(e.p.onSelectAll)&&e.p.onSelectAll.call(e,za?e.p.selarrrow:Aa,za)})}if(!0===e.p.autowidth){var
Ba=$(x).parent().width();ta=$(window).width(),e.p.width=ta-Ba>3?Ba:ta}var
Ca="",Da=-1!==e.p.styleUI.search("Bootstrap")?2:0;ba(),$(x).css("width",f.width+"px").append("<div class='ui-jqgrid-resize-mark' id='rs_m"+e.p.id+"'>&#160;</div>"),e.p.scrollPopUp&&$(x).append("<div "+l(m,"scrollBox",!1,"loading ui-scroll-popup")+" id='scroll_g"+e.p.id+"'></div>"),$(k).css("width",f.width+"px"),ua=$("thead:first",e).get(0),e.p.footerrow&&(Ca+="<table role='presentation' style='width:"+e.p.tblwidth+"px' "+l(m,"footerTable",!1,"ui-jqgrid-ftable ui-common-table")+"><tbody><tr role='row' "+l(m,"footerBox",!1,"footrow footrow-"+i)+">");var
Ea=$("tr:first",ua),Fa="<tr class='jqgfirstrow' role='row'>";if(e.p.disableClick=!1,$("th",Ea).each(function(a){ta=e.p.colModel[a],na=ta.width,void
0===ta.resizable&&(ta.resizable=!0),ta.resizable?(oa=document.createElement("span"),$(oa).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-"+i).css("cursor","col-resize"),$(this).addClass(e.p.resizeclass)):oa="",$(this).css("width",na+"px").prepend(oa),oa=null;var
b="";ta.hidden&&($(this).css("display","none"),b="display:none;"),Fa+="<td role='gridcell' style='height:0px;width:"+na+"px;"+b+"'></td>",f.headers[a]={width:na,el:this},"boolean"!=typeof(va=ta.sortable)&&(ta.sortable=!0,va=!0);var
c=ta.name;"cb"!==c&&"subgrid"!==c&&"rn"!==c&&e.p.viewsortcols[2]&&$(">div",this).addClass("ui-jqgrid-sortable"),va&&(e.p.multiSort?e.p.viewsortcols[0]?($("div span.s-ico",this).show(),ta.lso&&$("div span.ui-icon-"+ta.lso,this).removeClass(n).css("display","")):ta.lso&&($("div span.s-ico",this).show(),$("div span.ui-icon-"+ta.lso,this).removeClass(n).css("display","")):e.p.viewsortcols[0]?($("div span.s-ico",this).show(),a===e.p.lastsort&&$("div span.ui-icon-"+e.p.sortorder,this).removeClass(n).css("display","")):a===e.p.lastsort&&""!==e.p.sortname&&($("div span.s-ico",this).show(),$("div span.ui-icon-"+e.p.sortorder,this).removeClass(n).css("display",""))),e.p.footerrow&&(Ca+="<td role='gridcell' "+B(a,0,"",null,"",!1)+">&#160;</td>")}).mousedown(function(a){if(1===$(a.target).closest("th>span.ui-jqgrid-resize").length){var
b=ea(this);return!0===e.p.forceFit&&(e.p.nv=ca(b)),f.dragStart(b,a,da(b)),!1}}).click(function(a){if(e.p.disableClick)return e.p.disableClick=!1,!1;var
...
g=ea(this);if($(a.target).hasClass("colmenuspan")){null!=$("#column_menu")[0]&&$("#column_menu").remove();var
i=$.jgrid.getCellIndex(a.target);if(-1===i)return;var
j=$(this).offset(),k=j.left,l=j.top;return"ltr"===e.p.direction&&(k+=$(this).outerWidth()),ka(i,k,l,f),!0===e.p.menubar&&$("#"+e.p.id+"_menubar").hide(),void
a.stopPropagation()}return e.p.viewsortcols[2]||(b=!0,c=f.attr("sort")),null!=g&&aa($("div",this)[0].id,g,b,c,this),!1}}),ta=null,e.p.sortable&&$.fn.sortable)try{$(e).jqGrid("sortableColumns",Ea)}catch(a){}e.p.footerrow&&(Ca+="</tr></tbody></table>"),Fa+="</tr>",ra=document.createElement("tbody"),this.appendChild(ra),$(this).addClass(l(m,"rowTable",!0,"ui-jqgrid-btable ui-common-table")).append(Fa),e.p.altRows&&$(this).addClass(l(m,"stripedTable",!0,"")),Fa=null;var
Ga=$("<table "+l(m,"headerTable",!1,"ui-jqgrid-htable ui-common-table")+" style='width:"+e.p.tblwidth+"px' role='presentation' aria-labelledby='gbox_"+this.id+"'></table>").append(ua),Ha=!(!e.p.caption||!0!==e.p.hiddengrid),Ia=$("<div class='ui-jqgrid-hbox"+("rtl"===i?"-rtl":"")+"'></div>");ua=null,f.hDiv=document.createElement("div"),f.hDiv.style.width=f.width-Da+"px",f.hDiv.className=l(m,"headerDiv",!0,"ui-jqgrid-hdiv"),$(f.hDiv).append(Ia),$(Ia).append(Ga),Ga=null,Ha&&$(f.hDiv).hide(),e.p.pager&&("string"==typeof
e.p.pager?"#"!==e.p.pager.substr(0,1)&&(e.p.pager="#"+e.p.pager):e.p.pager="#"+$(e.p.pager).attr("id"),$(e.p.pager).css({width:f.width-Da+"px"}).addClass(l(m,"pagerBox",!0,"ui-jqgrid-pager")).appendTo(x),Ha&&$(e.p.pager).hide(),Z(e.p.pager,"")),!1===e.p.cellEdit&&!0===e.p.hoverrows&&$(e).on({mouseover:function(a){qa=$(a.target).closest("tr.jqgrow"),"ui-subgrid"!==$(qa).attr("class")&&$(qa).addClass(p)},mouseout:function(a){qa=$(a.target).closest("tr.jqgrow"),$(qa).removeClass(p)}});var
Ja,Ka,La;$(e).before(f.hDiv).on({click:function(a){if(pa=a.target,qa=$(pa,e.rows).closest("tr.jqgrow"),0===$(qa).length||qa[0].className.indexOf(n)>-1||($(pa,e).closest("table.ui-jqgrid-btable").attr("id")||"").replace("_frozen","")!==e.id)return this;var
c=$(pa).filter(":enabled").hasClass("cbox"),d=$(e).triggerHandler("jqGridBeforeSelectRow",[qa[0].id,a]);if(d=!1!==d&&"stop"!==d,$.isFunction(e.p.beforeSelectRow)){var
f=e.p.beforeSelectRow.call(e,qa[0].id,a);!1!==f&&"stop"!==f||(d=!1)}if("A"!==pa.tagName&&("INPUT"!==pa.tagName&&"TEXTAREA"!==pa.tagName&&"OPTION"!==pa.tagName&&"SELECT"!==pa.tagName||c))if(Ja=qa[0].id,pa=$(pa).closest("tr.jqgrow>td"),pa.length>0&&(Ka=$.jgrid.getCellIndex(pa)),!0!==e.p.cellEdit){if(pa.length>0&&(La=$(pa).closest("td,th").html(),$(e).triggerHandler("jqGridCellSelect",[Ja,Ka,La,a]),$.isFunction(e.p.onCellSelect)&&e.p.onCellSelect.call(e,Ja,Ka,La,a)),d)if(e.p.multimail&&e.p.multiselect){if(a.shiftKey){if(c){var
g=$(e).jqGrid("getGridParam","selrow"),h=$(e).jqGrid("getInd",Ja),i=$(e).jqGrid("getInd",g),j="",k="";h>i?(j=g,k=Ja):(j=Ja,k=g);var
l=!1,m=!1,o=!0;return $.inArray(Ja,e.p.selarrrow)>-1&&(o=!1),$.each($(this).getDataIDs(),function(a,b){return(m=b===j||m)&&$(e).jqGrid("resetSelection",b),b!==k}),o&&$.each($(this).getDataIDs(),function(a,b){return(l=b===j||l)&&$(e).jqGrid("setSelection",b,!1),b!==k}),void(e.p.selrow=h>i?k:j)}window.getSelection().removeAllRanges()}b(Ja,c,a,!1)}else
e.p.multikey?a[e.p.multikey]?$(e).jqGrid("setSelection",Ja,!0,a):e.p.multiselect&&c&&(c=$("#jqg_"+$.jgrid.jqID(e.p.id)+"_"+Ja).is(":checked"),$("#jqg_"+$.jgrid.jqID(e.p.id)+"_"+Ja)[e.p.useProp?"prop":"attr"]("checked",!c)):b(Ja,c,a,!0)}else
if(e.p.multiselect&&c&&d)$(e).jqGrid("setSelection",Ja,!0,a);else
if(pa.length>0)try{$(e).jqGrid("editCell",qa[0].rowIndex,Ka,!0,a)}catch(a){}},reloadGrid:function(a,b){if(!0===e.p.treeGrid&&(e.p.datatype=e.p.treedatatype),b=b||{},b.current&&e.grid.selectionPreserver(e),"local"===e.p.datatype?($(e).jqGrid("resetSelection"),e.p.data.length&&(K(),L())):e.p.treeGrid||(e.p.selrow=null,e.p.multiselect&&(e.p.selarrrow=[],Y(!1)),e.p.savedRow=[]),e.p.scroll&&J.call(e,!0,!1),b.page){var
...
0===b.page?(delete
e.p.lastpage,e.grid.populateVisible()):e.grid.populate(),!0===e.p.inlineNav&&$(e).jqGrid("showAddEditButtons"),!1},dblclick:function(a){if(pa=a.target,qa=$(pa,e.rows).closest("tr.jqgrow"),0!==$(qa).length){Ja=qa[0].rowIndex,Ka=$.jgrid.getCellIndex(pa);var
b=$(e).triggerHandler("jqGridDblClickRow",[$(qa).attr("id"),Ja,Ka,a]);return null!=b?b:$.isFunction(e.p.ondblClickRow)&&null!=(b=e.p.ondblClickRow.call(e,$(qa).attr("id"),Ja,Ka,a))?b:void
0}},contextmenu:function(a){if(pa=a.target,qa=$(pa,e.rows).closest("tr.jqgrow"),0!==$(qa).length){e.p.multiselect||$(e).jqGrid("setSelection",qa[0].id,!0,a),Ja=qa[0].rowIndex,Ka=$.jgrid.getCellIndex(pa);var
b=$(e).triggerHandler("jqGridRightClickRow",[$(qa).attr("id"),Ja,Ka,a]);return null!=b?b:$.isFunction(e.p.onRightClickRow)&&null!=(b=e.p.onRightClickRow.call(e,$(qa).attr("id"),Ja,Ka,a))?b:void
0}}}),f.bDiv=document.createElement("div"),t&&"auto"===String(e.p.height).toLowerCase()&&(e.p.height="100%"),$(f.bDiv).append($('<div style="position:relative;"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({height:e.p.height+(isNaN(e.p.height)?"":"px"),width:f.width-Da+"px"}).scroll(f.scrollGrid),$("table:first",f.bDiv).css({width:e.p.tblwidth+"px"}),$.support.tbody||2===$("tbody",this).length&&$("tbody:gt(0)",this).remove(),e.p.multikey&&($.jgrid.msie()?$(f.bDiv).on("selectstart",function(){return!1}):$(f.bDiv).on("mousedown",function(){return!1})),Ha&&$(f.bDiv).hide();var
Ma=r+" "+l(m,"icon_caption_open",!0),Na=r+" "+l(m,"icon_caption_close",!0);f.cDiv=document.createElement("div");var
Oa=!0===e.p.hidegrid?$("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton "+q+"' title='"+($.jgrid.getRegional(e,"defaults.showhide",e.p.showhide)||"")+"' />").hover(function(){Oa.addClass(p)},function(){Oa.removeClass(p)}).append("<span class='ui-jqgrid-headlink "+Ma+"'></span>").css("rtl"===i?"left":"right","0px"):"";if($(f.cDiv).append(Oa).append("<span class='ui-jqgrid-title'>"+e.p.caption+"</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption"+("rtl"===i?"-rtl":"")+" "+l(m,"gridtitleBox",!0)),!0===e.p.menubar){var
Pa='<ul id="'+e.p.id+'_menubar" class="ui-search-menu modal-content column-menu ui-menu jqgrid-caption-menu '+s.menu_widget+'" role="menubar" tabindex="0"></ul>';$("#gbox_"+e.p.id).append(Pa),$(f.cDiv).append("<a role='link' class='ui-jqgrid-menubar menubar-"+("rtl"===i?"rtl":"ltr")+"' style=''><span class='colmenuspan "+r+" "+s.icon_toolbar_menu+"'></span></a>"),$(".ui-jqgrid-menubar",f.cDiv).hover(function(){$(this).addClass(p)},function(){$(this).removeClass(p)}).on("click",function(a){var
b=$(a.target).offset();$("#"+e.p.id+"_menubar").show(),"rtl"===e.p.direction&&$("#"+e.p.id+"_menubar").css({left:b.left-$("#"+e.p.id+"_menubar").width()-20})})}if($(f.cDiv).insertBefore(f.hDiv),e.p.toolbar[0]){var
Qa=l(m,"customtoolbarBox",!0,"ui-userdata");f.uDiv=document.createElement("div"),"top"===e.p.toolbar[1]?$(f.uDiv).insertBefore(f.hDiv):"bottom"===e.p.toolbar[1]&&$(f.uDiv).insertAfter(f.hDiv),"both"===e.p.toolbar[1]?(f.ubDiv=document.createElement("div"),$(f.uDiv).addClass(Qa+" ui-userdata-top").attr("id","t_"+this.id).insertBefore(f.hDiv).width(f.width-Da),$(f.ubDiv).addClass(Qa+" ui-userdata-bottom").attr("id","tb_"+this.id).insertAfter(f.hDiv).width(f.width-Da),Ha&&$(f.ubDiv).hide()):$(f.uDiv).width(f.width-Da).addClass(Qa+" ui-userdata-top").attr("id","t_"+this.id),Ha&&$(f.uDiv).hide()}if(e.p.toppager&&(e.p.toppager=$.jgrid.jqID(e.p.id)+"_toppager",f.topDiv=$("<div id='"+e.p.toppager+"'></div>")[0],e.p.toppager="#"+e.p.toppager,$(f.topDiv).addClass(l(m,"toppagerBox",!0,"ui-jqgrid-toppager")).width(f.width-Da).insertBefore(f.hDiv),Z(e.p.toppager,"_t")),e.p.footerrow&&(f.sDiv=$("<div class='ui-jqgrid-sdiv'></div>")[0],Ia=$("<div class='ui-jqgrid-hbox"+("rtl"===i?"-rtl":"")+"'></div>"),$(f.sDiv).append(Ia).width(f.width-Da).insertAfter(f.hDiv),$(Ia).append(Ca),f.footers=$(".ui-jqgrid-ftable",f.sDiv)[0].rows[0].cells,e.p.rownumbers&&(f.footers[0].className=l(m,"rownumBox",!0,"jqgrid-rownum")),Ha&&$(f.sDiv).hide()),Ia=null,e.p.caption){var
Ra=e.p.datatype;!0===e.p.hidegrid&&($(".ui-jqgrid-titlebar-close",f.cDiv).click(function(a){var
b,c=$.isFunction(e.p.onHeaderClick),d=".ui-jqgrid-bdiv, .ui-jqgrid-hdiv, .ui-jqgrid-toppager, .ui-jqgrid-pager, .ui-jqgrid-sdiv",g=this;return!0===e.p.toolbar[0]&&("both"===e.p.toolbar[1]&&(d+=", #"+$(f.ubDiv).attr("id")),d+=", #"+$(f.uDiv).attr("id")),b=$(d,"#gview_"+$.jgrid.jqID(e.p.id)).length,"visible"===e.p.gridstate?$(d,"#gbox_"+$.jgrid.jqID(e.p.id)).slideUp("fast",function(){0===--b&&($("span",g).removeClass(Ma).addClass(Na),e.p.gridstate="hidden",$("#gbox_"+$.jgrid.jqID(e.p.id)).hasClass("ui-resizable")&&$(".ui-resizable-handle","#gbox_"+$.jgrid.jqID(e.p.id)).hide(),$(e).triggerHandler("jqGridHeaderClick",[e.p.gridstate,a]),c&&(Ha||e.p.onHeaderClick.call(e,e.p.gridstate,a)))}):"hidden"===e.p.gridstate&&$(d,"#gbox_"+$.jgrid.jqID(e.p.id)).slideDown("fast",function(){0===--b&&($("span",g).removeClass(Na).addClass(Ma),Ha&&(e.p.datatype=Ra,X(),Ha=!1),e.p.gridstate="visible",$("#gbox_"+$.jgrid.jqID(e.p.id)).hasClass("ui-resizable")&&$(".ui-resizable-handle","#gbox_"+$.jgrid.jqID(e.p.id)).show(),$(e).triggerHandler("jqGridHeaderClick",[e.p.gridstate,a]),c&&(Ha||e.p.onHeaderClick.call(e,e.p.gridstate,a)))}),!1}),Ha&&(e.p.datatype="local",$(".ui-jqgrid-titlebar-close",f.cDiv).trigger("click")))}else
...
c,d,e,f,g=this,h=0,i=$.jgrid.cell_width?0:g.p.cellLayout,j=0,k=!1,l=g.p.scrollOffset,m=0,n=-1!==g.p.styleUI.search("Bootstrap")?2:0;if("boolean"!=typeof
...
i=a.p.selrow;if(f=a.p._index[$.jgrid.stripPref(a.p.idPrefix,g.id)],37===c.keyCode||38===c.keyCode||39===c.keyCode||40===c.keyCode){if(38===c.keyCode){if(e=g.previousSibling,d="",e)if($(e).is(":hidden")){for(;e;)if(e=e.previousSibling,!$(e).is(":hidden")&&$(e).hasClass("jqgrow")){d=e.id;break}}else
d=e.id;$(a).jqGrid("setSelection",d,!0,c),$(a).triggerHandler("jqGridKeyUp",[d,i,c]),$.isFunction(b.onUpKey)&&b.onUpKey.call(a,d,i,c),c.preventDefault()}if(40===c.keyCode){if(e=g.nextSibling,d="",e)if($(e).is(":hidden")){for(;e;)if(e=e.nextSibling,!$(e).is(":hidden")&&$(e).hasClass("jqgrow")){d=e.id;break}}else
...
13===c.keyCode?($(a).triggerHandler("jqGridKeyEnter",[a.p.selrow,c]),$.isFunction(b.onEnter)&&b.onEnter.call(a,a.p.selrow,c)):32===c.keyCode&&($(a).triggerHandler("jqGridKeySpace",[a.p.selrow,c]),$.isFunction(b.onSpace)&&b.onSpace.call(a,a.p.selrow,c))}}),$(a).on("click",function(b){$(b.target,a.rows).closest("tr.jqgrow").focus()})})},unbindKeys:function(){return this.each(function(){$(this).off("keydown")})},getLocalRow:function(a){var
...
s,t,u,v,w,x,y;if(k&&a.jgrid.filterRefactor({ruleGroup:q,ssfield:l,splitSelect:b.splitSelect,groupOpSelect:b.groupOpSelect}),m&&(a.isPlainObject(s)||(s=a.jgrid.parse(q)),s.rules&&s.rules.length))for(t=s.rules,u=0;u<t.length;u++)w=t[u],"bt"===w.op&&(x=w.data.split("..."),x.length>1&&(void
...
e,f=this,g=!1;if(f.grid&&!0===f.p.cellEdit){for(e=c+1;e<f.p.colModel.length;e++)if(!0===f.p.colModel[e].editable&&(!a.isFunction(f.p.isCellEditable)||f.p.isCellEditable.call(f,f.p.colModel[e].name,b,e))){g=e;break}!1!==g?a(f).jqGrid("editCell",b,g,!0,d):f.p.savedRow.length>0&&a(f).jqGrid("saveCell",b,c)}})},prevCell:function(b,c,d){return this.each(function(){var
e,f=this,g=!1;if(f.grid&&!0===f.p.cellEdit){for(e=c-1;e>=0;e--)if(!0===f.p.colModel[e].editable&&(!a.isFunction(f.p.isCellEditable)||f.p.isCellEditable.call(f,f.p.colModel[e].name,b,e))){g=e;break}!1!==g?a(f).jqGrid("editCell",b,g,!0,d):f.p.savedRow.length>0&&a(f).jqGrid("saveCell",b,c)}})},GridNav:function(){return this.each(function(){function
...
Array(c.collen),p=0;for(i=g;i<n;i++)if(m[i].exportcol){var
...
0!==v?v.startRow:g.groups[d].startRow+g.groups[d].cnt;for(s=x;s<y&&b[s-w];s++){for(u=b[s-w],q=0,t=0;t<m.length;t++)m[t].exportcol&&(n[q]=a.jgrid.formatCellCsv(a.jgrid.formatCell(u[m[t].name],t,u,m[t],j,"csv"),c),q++);f+=n.join(c.separator)+c.newLine}if("header"!==g.groupSummaryPos[k.idx]){var
z;if(void
...
e,f,g,h,i,j=this,k=this.addLocalData(!0),l=k.length,m=j.p.colModel,n=m.length,o=j.p.colNames,p=0,q="",r="",s="",t="",u="",v=[],w=[];if(a.each(m,function(c,d){void
0===d.exportcol&&(d.hidden?d.exportcol=!1:d.exportcol=!0),"cb"!==d.name&&"rn"!==d.name&&"subgrid"!==d.name||(d.exportcol=!1),d.exportcol&&(v.push(a.jgrid.formatCellCsv(o[c],b)),w.push(d.name))}),b.includeLabels&&(u=v.join(b.separator)+b.newLine),b.collen=v.length,j.p.grouping){var
x=!!j.p.groupingView._locgr;j.p.groupingView._locgr=!1,q+=d(k,b),j.p.groupingView._locgr=x}else
for(;p<l;){for(f=k[p],g=[],h=0,e=0;e<n;e++)m[e].exportcol&&(g[h]=a.jgrid.formatCellCsv(a.jgrid.formatCell(f[m[e].name],e,f,m[e],j,"csv"),b),h++);q+=g.join(b.separator)+b.newLine,p++}if(k=null,g=new
...
for(d=a;d>=0;d--)if(c[d].idx===f-b){e=c[d];break}}return e}function
d(b,d,f,h){var
i,k,l=c(b,d,f),n=l.cnt,p=e(o.header);for(k=h;k<j;k++)if(m[k].exportcol){var
...
0===m[e].exportcol&&(m[e].hidden?m[e].exportcol=!1:m[e].exportcol=!0),"cb"!==m[e].name&&"rn"!==m[e].name&&"subgrid"!==m[e].name&&m[e].exportcol&&(o.header[n]=m[e].name,o.width[n]=5,o.map[n]=e,n++);var
...
H=a.jgrid.makeNode(j,"cols");for(a("worksheet",j).prepend(H),n=0,f=o.width.length;n<f;n++)H.appendChild(a.jgrid.makeNode(j,"col",{attr:{min:n+1,max:n+1,width:o.width[n],customWidth:1}}));a.isFunction(b.onBeforeExport)&&b.onBeforeExport(l),o=null;try{var
I=new
...
for(d=a;d>=0;d--)if(c[d].idx===f-b){e=c[d];break}}return e}function
e(b,c,e,g){var
i,j,k=d(b,c,e),l=k.cnt,n=f(m);for(j=g;j<s;j++)if(q[j].exportcol){var
...
0===j[d].exportcol&&(j[d].hidden?j[d].exportcol=!1:j[d].exportcol=!0),"cb"!==j[d].name&&"rn"!==j[d].name&&"subgrid"!==j[d].name&&j[d].exportcol&&(k={text:h.p.colNames[d],style:"tableHeader"},p.push(k),m[n]=j[d].name,o[n]=d,q.push(j[d].width),r[j[d].name]=j[d].align||"left",n++);var
...
for(d=a;d>=0;d--)if(c[d].idx===f-b){e=c[d];break}}return e}function
d(b,d,f,i){var
k,m,n=c(b,d,f),o=n.cnt,p=e(j.header);for(m=i;m<l;m++)if(!h[m].hidden&&h[m].exportcol){var
...
e,f,g=this,h=g.p.colModel,i=0,j={body:g.addLocalData(!0),header:[],footer:[],width:[],map:[],align:[]};for(e=0,f=h.length;e<f;e++)void
0===h[e].exportcol&&(h[e].exportcol=!0),!h[e].hidden&&"cb"!==h[e].name&&"rn"!==h[e].name&&"subgrid"!==h[e].name&&h[e].exportcol&&(j.header[i]=h[e].name,j.width[i]=h[e].width,j.map[i]=e,j.align[i]=h[e].align||"left",i++);var
